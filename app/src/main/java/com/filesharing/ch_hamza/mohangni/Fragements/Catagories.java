package com.filesharing.ch_hamza.mohangni.Fragements;
...
import com.filesharing.ch_hamza.mohangni.Adapters.Main_Catagory_Adapter;
...
public class Catagories extends Fragment {
    ...
    ArrayList<com.filesharing.ch_hamza.mohangni.PojoClass.Catagories> arrayList=new ArrayList<>();
                ...
                try {
                    ...
                    for (int i=0;i<data_level0.length();i++)
                    {
                        ...
                        for (int j =0 ;j< data_level1.length(); j++){
                            ...
                            {
                                arrayList.add(new com.filesharing.ch_hamza.mohangni.PojoClass.Catagories(cat.getString("category_id"),cat.getString("parent_id"),
                                        cat.getString("name"),
